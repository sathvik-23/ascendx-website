          ...
          <div className="flex flex-col items-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] text-gray-500 md:text-xl dark:text-gray-400">
                ...
                discuss a potential project, our team is ready to assist.
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">
                  Fill out the form and we'll get back to you promptly. We're excited to learn about your project and
                  how we can help.
                </p>
              </div>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>Tell us about your project or inquiry.</FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
            ...
            <p className="mx-auto max-w-[700px] text-gray-500 dark:text-gray-400">
              We're located in the heart of the city. Feel free to stop by for a coffee and a chat.
            </p>
          </div>
        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="mx-auto max-w-[700px] md:text-xl">Reach out today, and we'll get back to you promptly!</p>
            </div>
          </div>
        </div>
      </section>
